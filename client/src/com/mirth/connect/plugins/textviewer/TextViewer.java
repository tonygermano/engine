...
public class TextViewer extends AttachmentViewer {
    ...
    public void viewAttachments(String channelId, Long messageId, String attachmentId) {
        ...
        try {
            ...
            final JEditorPane jEditorPane = new JEditorPane(isRTF ? "text/rtf" : "text/plain", Base64.isBase64(attachment.getContent()) ? org.apache.commons.codec.binary.StringUtils.newStringUtf8(Base64.decodeBase64(attachment.getContent())) : org.apache.commons.codec.binary.StringUtils.newStringUtf8(attachment.getContent()));
            ...
            if (Base64.isBase64(attachment.getContent())) {
